...
export default function WellsFamilySessionPage() {
  ...
  useEffect(() => {
    trackViewContent('Portfolio', 'Dallas Family Session');
  }, []);
        ...
        <section className="pt-20 md:pt-32 pb-8 md:pb-20 px-4 md:px-16">
          <div className="max-w-[1800px] mx-auto">
            ...
            <div className="space-y-4 md:space-y-8 mb-8 md:mb-16">
              <span className="text-[8px] md:text-[10px] uppercase tracking-[0.5em] md:tracking-[0.6em] text-slate/40 block">Family Session</span>
          ...
          <div className="max-w-[1800px] mx-auto">
              ...
              <div className="grid grid-cols-2 gap-2">
                {(() => {
                  ...
                  return displayedImages.map((image, i) => {
                    const actualIndex = i; // Index in the displayed slice
                    ...
                    // Mid-gallery CTA after 6th image (index 7)
            ...
            <div className="hidden md:block">
              <div className="columns-2 lg:columns-3 gap-4">
                {images
                  .slice(0, showAllImages ? images.length : INITIAL_IMAGE_COUNT)
                  .map((image, i) => {
                    // Mid-gallery CTA after 8th image (desktop)
