          ...
          <div className="max-w-[1200px] mx-auto text-center space-y-12">
            <div className="space-y-6">
              <h2 className="text-4xl md:text-5xl font-serif text-slate tracking-tight">
                Ready for Your <br />
                <span className="italic opacity-60">Mini Session?</span>
              </h2>
              <p className="text-lg text-slate/60 font-sans font-light max-w-xl mx-auto">
                Perfect for quick updates and milestone moments. Fill out the form below and I'll get back to you within 24 hours to discuss your mini session.
              </p>
            </div>
