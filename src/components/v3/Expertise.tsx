...
const pillars = [
  {
    ...
    titleLink: "/services/dallas-family-photography",
  ...
  },
  {
    id: "02",
    title: "Maternity",
    titleLink: "/services/dallas-maternity-photography",
  ...
  },
  {
    ...
    titleLink: "/services/baby-announcement-photography",
  ...
  },
  {
    id: "04",
    title: "Mini Sessions",
    titleLink: "/dallas-mini-sessions",
        ...
        <div className="lg:col-span-4 space-y-8 sticky top-32">
          ...
          <div className="pt-8">
             <a 
               ...
               className="group flex items-center gap-4 text-[11px] uppercase tracking-[0.4em] text-slate hover:text-moss transition-colors duration-500"
             >
               View the Experience
               <div className="w-8 h-[1px] bg-sand transition-all duration-500 group-hover:w-16 group-hover:bg-moss" />
             </a>
          </div>
        </div>
          ...
          {pillars.map((pillar, i) => (
            ...
            >
              <div className="flex items-baseline justify-between border-b border-sand pb-4">
                <span className="text-2xl font-serif italic text-sand">{pillar.id}</span>
                <div className="p-2 bg-bone rounded-full text-slate/40">
                  {pillar.icon}
                </div>
              </div>
              <h3 className="text-2xl font-serif text-slate uppercase tracking-tight">
                {pillar.titleLink ? (
