...
export function Hero() {
  ...
  return (
    <section className="relative w-full h-[110vh] overflow-hidden bg-bone flex items-center pt-20">
      <div className="max-w-[1800px] mx-auto w-full px-6 md:px-16 grid grid-cols-1 lg:grid-cols-12 gap-16 relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center space-y-12 relative z-20">
          ...
          >
            ...
            <h1 className="text-[15vw] lg:text-[6.5vw] xl:text-[6vw] font-serif leading-[0.85] text-slate tracking-tighter">
              Real Moments. <br />
            ...
            <p className="text-lg md:text-xl text-slate/60 font-sans font-light max-w-lg leading-relaxed">
          ...
          >
            <a 
              ...
              className="group relative bg-slate text-bone px-12 py-6 rounded-sm text-[11px] uppercase tracking-[0.5em] overflow-hidden transition-all hover:pr-16 inline-block"
            >
